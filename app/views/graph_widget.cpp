    ...
    QWidget(parent)
{
    ...
    CHECKED_CONNECT(this, SIGNAL(segmentationChanged(SongSegmentation*)),
                    Dispatch::Singleton()->getTransport(), SLOT(segmentsChanged(SongSegmentation*)));
    CHECKED_CONNECT(Dispatch::Singleton()->getEngine(), SIGNAL(playPositionChanged(qint64)),
...
{
    CHECKED_CONNECT(Dispatch::Singleton()->getEngine(), SIGNAL(newSong(QString)),
...
int GraphWidget::whatToActivate()
{
    ...
    int ms = Dispatch::getPlaybackPositionUSecs()/1000;
