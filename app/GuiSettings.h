...
class GuiSettings : public QWidget
{
    ...
    Q_PROPERTY(int       paramTextOffset        MEMBER m_paramTextOffset)
    Q_PROPERTY(int       paramEditorOffset      MEMBER m_paramEditorOffset)
    Q_PROPERTY(int       paramBorderRadius      MEMBER m_paramBorderRadius)
    Q_PROPERTY(int       paramBorderWidth       MEMBER m_paramBorderWidth)
...
public:
    ...
    int         m_paramTextOffset;
    int         m_paramEditorOffset;
    int         m_paramBorderRadius;
    int         m_paramBorderWidth;
    QColor      m_paramBorderColor;
    ...
    // Derived
    QPen        m_socketOutlinePen;
    QPen        m_connectorPen;
    QPen        m_connectorPenSelected;
    QBrush      m_connectorBrush;
